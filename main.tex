...
\fancyhead[C]{Rider Abandonment in Grand Tour Cycling} % Centreret sidehoved
...
\input{Afsnit/1. INTRODUCTION}

\input{Afsnit/2. THEORETICAL FRAMEWORK AND LITERATURE}

\input{Afsnit/3. DATA}

\input{Afsnit/4. EMPIRICAL STRATEGY}

\input{Afsnit/5. RESULTS}

\input{Afsnit/6. ROBUSTNESS CHECKS AND EXTENSIONS}

\input{Afsnit/DISCUSSION}

\input{Afsnit/7. CONCLUSION}
