...
The paper is structured as follows. Section~\ref{sec:theory} presents the theoretical framework and reviews relevant literature. Section~\ref{sec:data} describes the data and variables. Section~\ref{sec:empirical_strategy} explains the methodology. Section~\ref{sec:results} presents results. Section~\ref{sec:robustness} provides robustness checks, and Section~\ref{sec:conclusion} concludes.
